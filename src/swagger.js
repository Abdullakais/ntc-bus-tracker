...
// --- START Dynamic Host Fix ---
// RENDER_EXTERNAL_URL is provided automatically by Render for deployed environments.
// We use it to determine the correct host, defaulting to localhost for development.
...
    servers: [
      {
        url: `${deployedScheme}://${deployedHost}`, // Use the dynamic scheme and host
